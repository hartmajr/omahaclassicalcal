# Omaha Classical Calendar — developer notes

*Design record and operating manual for the pipeline. The public-facing
summary is the repository [README](../README.md).*
